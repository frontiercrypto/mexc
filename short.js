...
(async () => {
    ...
    try {
        ...
        await withTimeout(() => page.waitForSelector('label.ant-checkbox-wrapper:has-text("Short TP/SL") input.ant-checkbox-input'), page);
        await withTimeout(() => page.click('label.ant-checkbox-wrapper:has-text("Short TP/SL") input.ant-checkbox-input'), page);
